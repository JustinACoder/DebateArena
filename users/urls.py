...
urlpatterns = [
    ...
    path('settings/<str:tab>/', users.views.account_settings, name='account_settings'),
    ...
    path('profile/<str:username>/edit/', users.views.account_profile_edit, name='account_profile_edit'),
]
